...
## [2.0.3] - 2026-08-28
### Fixed
- UsbDeviceCdc::defaultName static initialization order dependency.

## [2.0.2] - 2026-08-25
### Fixed
- UsbDeviceCdc destructor not disabling the port, so disabledEvent never fired on destruction.

## [2.0.1] - 2026-08-24
### Fixed
- usb_device_cdc_echo_server example not stopping the server task before destruction.
