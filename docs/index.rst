...
Examples
--------
| `USB device CDC <https://components.espressif.com/components/plasmapper/pl_usb/versions/1.0.0/examples/usb_device_cdc>`_
| `USB device CDC echo server <https://components.espressif.com/components/plasmapper/pl_usb/versions/1.0.0/examples/usb_device_cdc_echo_server>`_
